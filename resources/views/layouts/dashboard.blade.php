...
@section('konten')
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        <h1 class="display-4">Selamat datang di Website Presensi LAB ICT Universtas Budi Luhur</h1>
        <p class="lead">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">
                  Kami adalah kelompok 3 sebagai pembuat website ini, 
                  yang menyediakan solusi untuk memantau Presensi Asisten dengan mudah.
                </p>
